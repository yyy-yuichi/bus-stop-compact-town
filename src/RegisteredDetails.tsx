...
export default function RegisteredDetails({ details }: { details: ShoppingProperties['registered_details'] }) {
  ...
  return <section className="registered-details" aria-label="施設の登録情報">
    <h3>施設の登録情報</h3>
    <p className="helper-text">OpenStreetMap · {dates.join(' / ')}時点のデータ<br />営業状況・受付時間は施設へご確認ください。</p>
    <dl>
